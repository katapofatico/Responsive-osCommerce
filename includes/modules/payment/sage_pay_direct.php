...
*/
  ...
  class sage_pay_direct {
    ...
    function before_process() {
      global $HTTP_GET_VARS, $_POST, $customer_id, $order, $currency, $order_totals, $cartID, $sage_pay_response;
    ...
    function after_process() {
      global $HTTP_GET_VARS, $_POST, $customer_id, $insert_id, $sage_pay_response;
